...
@section('content')
    ...
    <header class="top-s">
        <div class="container">
            ...
            <span>الخدمات/منصات الموردين</span>
            <div class="title">
                <h1 class="fw-bold">منصات الموردين
                </h1>
            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <div class="content" style="text-align: right">
                                    ...
                                    <p>المنصة الأولى في المنطقة العربية للطلب من الموردين</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <div class="content" style="text-align: right">
                                    ...
                                    <p>  منصة لإدارة مشتريات المطاعم</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <div class="content" style="text-align: right">
                                    ...
                                    <p>  من أجل شراء أسهل من الموردين</p>
                                </div>
                            </div>
                        </div>
