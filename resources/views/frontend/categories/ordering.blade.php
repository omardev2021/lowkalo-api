...
@section('content')
    ...
    <header class="top-s">
        <div class="container">
            <span>Services / Ordering Platforms Management</span>
            <div class="title">
                <h1 class="fw-bold">Ordering Platforms Management
                </h1>
            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <div class="content">
                                    ...
                                    <p>  Manage Online Sales Channels from Your POS</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <div class="content">
                                    ...
                                    <p> Receive delivery and online orders to your Foodics dashboard! </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <div class="content">
                                    ...
                                    <p> Omni-channel restaurant & Delivery management
                                        .</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <div class="content">
                                    ...
                                    <p> Manage all your online orders from one place
                                        .</p>
                                </div>
                            </div>
                        </div>
