...
@section('content')
    ...
    <header class="top-s">
        <div class="container">
            <span>Services / Digital Receipts</span>
            <div class="title">
                <h1 class="fw-bold">Digital Receipts
                </h1>
            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <div class="content">
                                    ...
                                    <p> Your app for digitized receipts and keeping track of your expenditure </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <div class="content">
                                    ...
                                    <p> Digital receipts service for retailers and more
                                        .</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <div class="content">
                                    ...
                                    <p> Electronic invoice, Zakat compliance, loyalty program & Ads
