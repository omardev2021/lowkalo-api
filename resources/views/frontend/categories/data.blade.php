...
@section('content')
    ...
    <header class="top-s">
        <div class="container">
            <span>Services / Data & Analytics</span>
            <div class="title">
                <h1 class="fw-bold">Data & Analytics
                </h1>
            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <div class="content">
                                    ...
                                    <p>  Guess less, Sell more & Save resources</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <div class="content">
                                    ...
                                    <p>  Harness the power of data-driven insights and make fruitful decisions with Fruits360! </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <div class="content">
                                    ...
                                    <p> Empowering your restaurant with AI
                                        .</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <div class="content">
                                    ...
                                    <p> Apicbase is the leading F&B management software for multi-store businesses
                                        .</p>
                                </div>
                            </div>
                        </div>
