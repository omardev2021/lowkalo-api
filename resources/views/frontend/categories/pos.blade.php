...
@section('content')
    ...
    <header class="top-s">
        <div class="container">
            <span>Services / Point of sale (POS)</span>
            <div class="title">
                <h1 class="fw-bold">Point of sale (POS)
                </h1>
            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <div class="content">
                                    ...
                                    <p>  Digital platform that automates daily operations and streamlines food safety</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <div class="content">
                                    ...
                                    <p>  Odoo Inventory app automatically inputs any transaction from the POS in the stock. You can see in real-time the availability of products without losing time.</p>
                                </div>
                            </div>
                        </div>
