...
@section('content')
    ...
    <header class="top-s">
        <div class="container">
            <span>الخدمات/محطة الدفع</span>
            <div class="title">
                <h1 class="fw-bold">محطة الدفع
                </h1>
            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <div class="content" style="text-align: right">
                                    ...
                                    <p>  الطريقة الجديدة لقبول جميع أنواع المدفوعات وإدارة عملك بالكامل. </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <div class="content" style="text-align: right">
                                    ...
                                    <p> شركة رائدة في مجال التكنولوجيا المالية يتمثل دورها في تطوير القطاع الشخصي والتجاري ليكون أكثر أمانًا ونموًا
                                        .</p>
                                </div>
                            </div>
                        </div>
