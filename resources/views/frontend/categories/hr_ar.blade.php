...
@section('content')
    ...
    <header class="top-s">
        <div class="container">
            ...
            <span>الخدمات/الموارد البشرية</span>
            <div class="title">
                <h1 class="fw-bold">الموارد البشرية
                </h1>
            </div>
            ...
            <div class="col-sm-8">
                <div class="card border-0" >
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="images"><img src="{{asset('frontend/images/h1.jpg')}}" alt="" srcset=""></div>
                            </div>
                            <div class="col-sm-8">
                                <div class="content" style="text-align: right">
                                    ...
                                    <p>الحل السحابي الأمثل للموارد البشرية لأصحاب الأعمال الصغيرة
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="images"><img src="{{asset('frontend/images/h2.webp')}}" alt="" srcset=""></div>
                            </div>
                            <div class="col-sm-8">
                                <div class="content" style="text-align: right">
                                    <h2>جسر
