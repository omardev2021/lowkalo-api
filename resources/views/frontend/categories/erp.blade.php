...
@section('content')
    ...
    <header class="top-s">
        <div class="container">
            <span>Services / ERP</span>
            <div class="title">
                <h1 class="fw-bold">ERP
                </h1>
            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <div class="content">
                                    ...
                                    <p>Dafater: The Easiest and Most Affordable Accounting Program.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <div class="content">
                                    ...
                                    <p>  High-End Accounting ERP System</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <div class="content">
                                    ...
                                    <p>  Cloud Accounting Platform with CRM, Sales, HR, & more.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <div class="content">
                                    ...
                                    <p> Cloud ERP system for startups & SMEs
                                    </p>
                                </div>
                            </div>
                        </div>
