...
@section('content')
    ...
    <header class="top-s">
        <div class="container">
            <span>Services / Back of House</span>
            <div class="title">
                <h1 class="fw-bold">Back of House
                </h1>
            </div>
            ...
            <div class="col-sm-8">
                <div class="card border-0" >
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="images"><img src="{{asset('frontend/images/1.webp')}}" alt="" srcset=""></div>
                            </div>
                            <div class="col-sm-8">
                                <div class="content">
                                    <h2>xtrachef By toast
                                        <span> <i class="fa-sharp fa-solid fa-star" style="color: black"></i> 5.0</span>
                                    </h2>
                                    <p>  xtraCHEF, the leading accounts payable (AP) automation and back-office business intelligence solution for restaurants, today announced they’ve entered a preferred partnership agreement with Toast.</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="images"><img src="{{asset('frontend/images/2.png')}}" alt="" srcset=""></div>
                            </div>
                            <div class="col-sm-8">
                                <div class="content">
                                    <h2>Apicbase
                                    ...
                                    <p>  One platform to manage all kitchen ops</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="images"><img src="{{asset('frontend/images/c-2.png')}}" alt="" srcset=""></div>
                            </div>
                            <div class="col-sm-8">
                                <div class="content">
                                    <h2>supy
                                    ...
                                    <p>  The most efficient way to streamline the ordering process with your suppliers.</p>
                                </div>
                            </div>
                        </div>
