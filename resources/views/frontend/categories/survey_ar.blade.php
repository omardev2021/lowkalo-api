...
@section('content')
    ...
    <header class="top-s">
        <div class="container">
            ...
            <span>الخدمات/استبيانات</span>
            <div class="title">
                <h1 class="fw-bold">استبيانات
                </h1>
            </div>
            ...
            <div class="col-sm-8">
                <div class="card border-0" >
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="images"><img src="{{asset('frontend/images/du1.jpg')}}" alt="" srcset=""></div>
                            </div>
                            <div class="col-sm-8">
                                <div class="content" style="text-align: right">
                                    ...
                                    <p> قيم وراقب منتجاتك وموظفيك وحلل النتائج وطور عملك التجاري
                                    </p>
                                </div>
                            </div>
                        </div>
