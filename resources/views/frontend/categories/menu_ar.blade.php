...
@section('content')
    ...
    <header class="top-s">
        <div class="container">
            ...
            <span>الخدمات/القوائم الرقمية</span>
            <div class="title">
                <h1 class="fw-bold">القوائم الرقمية
                </h1>
            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <div class="content" style="text-align: right">
                                    ...
                                    <p>وفر تجربة رقمية متكاملة لعملائك.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <div class="content" style="text-align: right">
                                    ...
                                    <p>  حلول ذكيّة للمطاعم والتّوصيل والاستلام
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <div class="content" style="text-align: right">
                                    ...
                                    <p>  منيو مطعمك متاحة لعملائك بشكل أسهل</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <div class="content" style="text-align: right">
                                    ...
                                    <p>  عزز تجربة تناول الطعام من خلال خدمات الطلب الرقمية
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <div class="content" style="text-align: right">
                                    ...
                                    <p>  منيو ذكي ورائع يعمل بتقنية الاستجابة السريعة QR لتطلب ما تحب، وتدفع قيمته، وأكثر
                                    </p>
                                </div>
                            </div>
                        </div>
