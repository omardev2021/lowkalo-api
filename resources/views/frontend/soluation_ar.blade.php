...
<head>
    ...
    @if (Config::get('app.locale') == 'en')
        <title>{{$soluation->name}} - {{$soluation->category->name}} - Lowkalo</title>
        <link rel="canonical" href="https://www.lowkalo.com/en/{{$soluation->category->type}}/{{$soluation->category->slug}}/{{$soluation->name}}" />
        <link rel="alternate" href="https://www.lowkalo.com/en/{{$soluation->category->type}}/{{$soluation->category->slug}}" hreflang="en" />
        <link rel="alternate" href="https://www.lowkalo.com/{{$soluation->category->type}}/{{$soluation->category->slug}}" hreflang="ar" />
        <link rel="alternate" href="https://www.lowkalo.com/{{$soluation->category->type}}/{{$soluation->category->slug}}" hreflang="x-default" />
    @elseif(Config::get('app.locale') == 'ar')
        <title>{{$soluation->name_ar}} - {{$soluation->category->name_ar}} - لوكالو</title>
        <link rel="canonical" href="https://www.lowkalo.com/{{$soluation->category->type}}/{{$soluation->category->slug}}/{{$soluation->name}}" />
        <link rel="alternate" href="https://www.lowkalo.com/en/{{$soluation->category->type}}/{{$soluation->category->slug}}" hreflang="en" />
        <link rel="alternate" href="https://www.lowkalo.com/{{$soluation->category->type}}/{{$soluation->category->slug}}" hreflang="ar" />
        <link rel="alternate" href="https://www.lowkalo.com/{{$soluation->category->type}}/{{$soluation->category->slug}}" hreflang="x-default" />
    @endif
    ...
    <div class="w-70 mx-auto md:mx-0 md:mr-5" style="margin-left: 20px">
        ...
        >
            <div class="text-center px-6 py-2 pt-6">
                <h3 class="font-semibold text-base">اضافة تقييم</h3>
            ...
            <form action="{{route('rate',$soluation)}}" method="POST" enctype="multipart/form-data" class="space-y-4 px-4 py-6">
                ...
                {{--                </div>--}}
                <div>
                    <label class="font-semibold text-base" for="rate">التقييم</label>
                    <select name="rate" id="rate" required class="w-full bg-gray-100 text-sm rounded-xl border-none px-4 py-2">
                ...
                <div>
                    <textarea name="notes" required id="idea" cols="30" rows="4" class="w-full bg-gray-100 rounded-xl border-none placeholder-gray-900 text-sm px-4 py-2" placeholder="وصف التقييم"></textarea>
                </div>
                <div>
                    <label>الرجاء ارفاق فاتورة الاشتراك مع الشركة</label>
                    <input type="file" name="image_path">
                </div>
                <div class=" items-center justify-between space-x-3">
                    {{--                    <button--}}
                    {{--                        type="button"--}}
                    ...
                    @guest()
                        <div>
                            <h3 class="font-semibold text-base ">الرجاء تسجيل الدخول للتمكن من اضافة تقييم</h3>
                    ...
                    <div>
                        <button
                            ...
                            <span class="ml-1">تسجيل دخول</span>
                        </button>
                    </div>
                        <br>
...
@auth()
                    @if($rated)
                        <h3 class="font-semibold text-base">تم اضافة تقييم</h3>
...
{{--                    </button>--}}
        ...
        <div class="mt-8">
            ...
            <div>
                <a href="{{route('service.details',['type' => $soluation->category->type, 'slug' => $soluation->category->slug,'category'=>$soluation->category])}}" class="flex items-center font-semibold hover:underline">
                    <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7" />
                    </svg>
                    <span class="ml-2">الرجوع للخلف</span>
                </a>
            </div>
                ...
                <div class="flex flex-col md:flex-row flex-1 px-4 py-6">
                    ...
                    <div class="w-full mx-2 md:mx-4">
                        <h4 class="text-xl font-semibold">
                            <a href="#" class="hover:underline">{{$soluation->name_ar}}</a>
                        </h4>
                        <div class="text-gray-600 mt-3">
                            {{$soluation->body_ar}}                        </div>


                                <div class="flex flex-col md:flex-row md:items-center justify-between mt-6">
                                    <div class="flex items-center text-xs text-gray-400 font-semibold space-x-2">
                                        <div class="hidden md:block font-bold text-gray-900">{{$soluation->name_ar}}</div>
                                        <div class="hidden md:block">&bull;</div>

                                <div>{{$soluation->category->name_ar}}</div>
                                <div>&bull;</div>
                                <div class="text-gray-900">{{count($soluation->reviews)}} تقييم</div>
                            </div>
            ...
            <div class="buttons-container flex items-center justify-between mt-6">
                ...
                {{--                </div>--}}
                    ...
                    <div class="bg-white font-semibold text-center rounded-xl px-3 py-2">
                        ...
                        <div class="text-gray-400 text-xs leading-none">تقييم</div>
                    </div>
                    {{--                    <button--}}
                    {{--                        type="button"--}}
                    ...
                    {{--                    </button>--}}
                                ...
                                <div class="flex items-center justify-between mt-6">
                                    <div class="flex items-center text-xs text-gray-400 font-semibold space-x-2">
                                        ...
                                        <div>                                <img src="{{asset('images/verified.png')}}" width="25">
                                        </div>
                                        <div>                      عميل معتمد
                                        </div>
                                    </div>
...
{{--                                    </div>--}}
                                        ...
                                        @endif
                @endforeach <!-- end comment-container -->
    ...
    <footer class=" mt-5">
        <div class="row align-items-center ">
            ...
            <div class="col-sm-3 text-center">
                ...
                <div class="footer-content my-5">
                    ...
                    <h2 style="font-weight:bold;color: white">Low Kalo</h2><br>
            ...
            <div class="col-sm-9 text-center">
                ...
                <div class="footer-content my-5">
                    <div class="row">
                        <div class="col-sm-4">
                            <ul>
                                <li><a href="#" style="font-weight: bold">الصفحات</a></li>
                                <li><a href="#">الرئيسة</a></li>
                                <li><a href="#">عن Lowkalo</a></li>
                                <li><a href="#">تواصل معنا</a></li>
                            </ul>
                        </div>
                        <div class="col-sm-4">
                            <ul>
                                <li><a href="#" style="font-weight: bold">خدماتنا</a></li>
                                <li><a href="#">دورات تدريبية</a></li>
                                <li><a href="#">استشارة اون لاين</a></li>
              ...
              <li><a href="#">Connect</a></li> --}}
                        ...
                        <div class="col-sm-4">
                            <ul>
                                ...
                                <li><a href="#" style="font-weight: bold"> انضم الينا</a></li>
        ...
        <div class="paymetMethod text-center">
            <img src="{{ asset('frontend/images/en.png') }}"
                 style="max-width: 350px;margin-right: 38%">
        </div>
        <div class="text-center p-3" style="background-color: #4115BA;">
            <span style="font-size: 16px;color:#E0F8F6">جميع الحقوق محفوظة لـ© Lowkalo</span>
        </div>
    </footer>
</div>
