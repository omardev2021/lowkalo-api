...
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <a href="{{route('sol.form')}}"><button class="btn btn-primary">اضافة حل</button></a>
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4">الحلول</h4>
                    <div class="table-responsive">
                        <table class="table align-middle table-nowrap mb-0">
                            ...
                            <tr>
                                ...
                                <th class="align-middle">اسم الشركة عربي</th>
                                <th class="align-middle">عدد الزيارات</th>
                            </tr>
                            </thead>
                            <tbody>
                            @foreach ($soluations as $cat)
                                <tr>
