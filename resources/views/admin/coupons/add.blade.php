                            ...
                            <div class="col-sm-12">
                                <div class="mb-3">
                                    ...
                                    <input id="productname" name="coupon_name" type="text"
                                        ...
                                        placeholder="Coupon Name" value="{{ old('name') }}" autocomplete="name">
                                    @error('coupon_name')
                                ...
                                <div class="mb-3">
                                    ...
                                    <input id="coupon_discount" name="coupon_discount" type="number"
                                        ...
                                        placeholder="Coupon Discount (%)" value="{{ old('coupon_discount') }}"
                                ...
                                <div class="mb-3">
                                    <label for="productname">Coupon Expiration Date<label>
                                            <input id="coupon_validity" name="coupon_validity" type="date"
                                                ...
                                                placeholder="Coupon Expiration Date" value="{{ old('coupon_validity') }}"
